...
（1）[点击查看大图](http://gityuan.com/img/flutter_compile/SeqAST.jpg)

![SeqAST](http://gityuan.com/img/flutter_compile/SeqAST.jpg)

frontend_server前端编译器将dart代码转换为AST，并生成app.dill文件，其中bytecode生成过程默认是关闭的。

（2）[点击查看大图](http://gityuan.com/img/flutter_compile/FlutterComplile.jpg)

![FlutterComplile](https://gitee.com/ian_kevin126/picturebed/raw/master/windows/img/FlutterComplile.jpg)
